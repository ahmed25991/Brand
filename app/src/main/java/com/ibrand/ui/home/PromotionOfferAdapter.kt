...
import com.ibrand.databinding.ItemPromotionBinding
import com.ibrand.models.response.OfferModel

class PromotionOfferAdapter (itemClickListener: ItemClickListener) : BaseRecAdapter<OfferModel>(itemClickListener) {
    ...
    override fun bind(binding: ViewDataBinding, position: Int, itemClickListener: ItemClickListener?) {
        ...
        binding as ItemPromotionBinding
